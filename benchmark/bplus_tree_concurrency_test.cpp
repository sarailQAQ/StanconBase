...
BENCHMARK_DEFINE_F(InsertionBenchmark, Insertion)
(State& state) {
...
BENCHMARK_DEFINE_F(DeletionBenchmark, Deletion)
(State& state) {
  uint32_t max = GetRangeMax(state);
...
BENCHMARK_DEFINE_F(ScanBenchmark, Scan)
(State& state) {
...
BENCHMARK_DEFINE_F(MixtureBenchmark, Mixture)
(State& state) {
